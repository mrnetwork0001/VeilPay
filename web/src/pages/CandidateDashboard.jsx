    ...
    return (
      <div className="min-h-screen pt-32 pb-32 flex flex-col items-center justify-center px-6">
        ...
        <p className="text-ink-muted text-center max-w-sm mb-8 font-mono text-sm leading-relaxed">
          Connect the wallet you used to apply for jobs to view your applications.
        </p>
        ...
        <FadeIn>
          <div className="mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-chassis shadow-recessed rounded-full mb-6 border border-white/40">
              ...
              <span className="font-mono text-xs font-bold text-ink-muted uppercase tracking-widest">My Applications</span>
            </div>
            <h1 className="font-sans font-extrabold text-3xl md:text-5xl text-ink tracking-tight mb-2 drop-shadow-[0_1px_1px_#ffffff]">
              Application <span className="inline-block px-2 py-0.5 bg-accent text-ink rounded shadow-floating border border-ink/10">Tracker</span>
            </h1>
            <p className="text-ink-muted text-lg max-w-xl">
              Track your applications and match results. Your salary expectation stays encrypted regardless of the outcome.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
            {[
              { label: 'Total Applications', value: applications.length, color: 'text-ink', border: 'border-ink/10' },
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center min-h-[300px] text-ink-muted">
              ...
              <span className="font-mono text-xs uppercase tracking-widest font-bold">Loading applications...</span>
            </div>
            ...
            <div className="card text-center py-20 bg-muted/20 border-dashed border-2 border-white/20">
              ...
              <h3 className="font-sans font-bold text-2xl text-ink mb-3">No Applications Yet</h3>
              <p className="text-ink-muted text-sm font-mono uppercase tracking-widest mb-8">Apply to a job to get started.</p>
              <Link to="/jobs" className="btn btn-primary shadow-floating px-8">Browse Jobs</Link>
            </div>
          ) : (
                  ...
                  <div className="card overflow-hidden" id={`candidate-app-card-${i}`}>
                    ...
                    {app.matchRevealed && app.matchResult && (
                      <div className="mb-6 space-y-6">
                        <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4 shadow-recessed flex gap-3">
                          ...
                          <div>
                            <div className="font-mono font-bold text-xs text-green-600 uppercase tracking-widest mb-1">It's a Match!</div>
                            <p className="text-xs text-ink-muted font-mono leading-relaxed">
                              The employer has been notified and may unlock your resume. Your salary expectation remains encrypted.
                            </p>
                          </div>
                        </div>
                        <FheChat
                    ...
                    <div className="flex gap-2 flex-wrap">
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-accent text-ink rounded border border-ink/10 text-[10px] font-mono font-bold uppercase tracking-widest shadow-floating">
                        <Lock className="w-3 h-3 text-ink" /> Salary Encrypted
                      </span>
